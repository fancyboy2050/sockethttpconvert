 ...
 * 快用-RSA签名验签类
 */
public class KYRSASignature {

	private static final Logger logger = LoggerFactory.getLogger(KYRSAEncrypt.class);
	...
	*/
	public static String sign(String content, String privateKey, String encode) {
		...
		try {
			...
			logger.error("KYRSASignature sign failed!", e);
		}
	...
	*/
	...
	public static void main(String[] args) {
		...
		try {
			String dataEncrypted = KYRSASignature.sign(encryptStr, prikey);
			System.out.println("签名结果:" + dataEncrypted);
			if (KYRSASignature.doCheck(encryptStr, dataEncrypted, pubkey)) {
